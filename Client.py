...
def com():
    ...
    label2 = tk.Label(text=c,font=20,fg='green') # it will print value in c
    label2.grid(row=2, column=0)

label1 = tk.Label(root, text="No, this is Patrick")
label1.grid(row=1, column=1)

# button = tk.Button(text='Press start to play', command=com(), fg='blue').pack()
